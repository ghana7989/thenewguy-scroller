...
[scroller Code of Conduct](https://github.com/ghana7989/thenewguy-scrollerblob/master/CODE_OF_CONDUCT.md).
...
> [Documentation](https://github.com/ghana7989/thenewguy-scroller).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/ghana7989/thenewguy-scroller/issues) that might help
...
- Open an [Issue](https://github.com/ghana7989/thenewguy-scroller/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using
  ...
  [documentation](https://github.com/ghana7989/thenewguy-scroller). If you are
  looking for support, you might want to check
  [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the
  same issue you are having, check if there is not already a bug report existing
  for your bug or error in the
  [bug tracker](https://github.com/ghana7989/thenewguy-scrollerissues?q=label%3Abug).
...
scroller, **including completely new features and minor improvements to existing
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/ghana7989/thenewguy-scroller)
  carefully and find out if the functionality is already covered, maybe by an
  individual configuration.
- Perform a [search](https://github.com/ghana7989/thenewguy-scroller/issues) to
...
[GitHub issues](https://github.com/ghana7989/thenewguy-scroller/issues).
...
- **Explain why this enhancement would be useful** to most scroller users. You
